classdef QuadPlot_mod < handle
    %QuadPlot_mod Visualization class for quad
    ...
    methods
        % Constructor
        function Q = QuadPlot_mod(qn, state, wingspan, height, color, max_iter, h_3d)
            Q.qn = qn;
            Q.state = state;
            Q.wingspan = wingspan;
            Q.color = color;
        ...
        % Update quad plot
        function UpdateQuadPlot_mod(Q, state, des_state, time)
